...
namespace FRom.MyArray
{
[Serializable, ComVisible(true)]
public abstract class MyArray : ICloneable, IList, ICollection, IEnumerable
{
    // Methods
    private MyArray()
    {
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int BinarySearch(MyArray array, object value)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int BinarySearch(MyArray array, object value, IComparer comparer)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int BinarySearch(MyArray array, int index, int length, object value)
    {
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int BinarySearch(MyArray array, int index, int length, object value, IComparer comparer)
    {
        int num2;
        if (array == null)
        {
    ...
    public static extern void Clear(MyArray array, int index, int length);
    public object Clone()
    {
    ...
    public static void ConstrainedCopy(MyArray sourceArray, int sourceIndex, MyArray destinationArray, int destinationIndex, int length)
    {
    ...
    public static void Copy(MyArray sourceArray, MyArray destinationArray, int length)
    {
        if (sourceArray == null)
        {
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Copy(MyArray sourceArray, MyArray destinationArray, long length)
    {
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Copy(MyArray sourceArray, int sourceIndex, MyArray destinationArray, int destinationIndex, int length)
    {
        Copy(sourceArray, sourceIndex, destinationArray, destinationIndex, length, false);
    }

    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Copy(MyArray sourceArray, long sourceIndex, MyArray destinationArray, long destinationIndex, long length)
    {
    ...
    internal static extern void Copy(MyArray sourceArray, int sourceIndex, MyArray destinationArray, int destinationIndex, int length, bool reliable);
    public void CopyTo(MyArray array, int index)
    {
    ...
    [ComVisible(false)]
    public void CopyTo(MyArray array, long index)
    {
    ...
    public static unsafe MyArray CreateInstance(Type elementType, params int[] lengths)
    {
        if (elementType == null)
        {
    ...
    public static MyArray CreateInstance(Type elementType, params long[] lengths)
    {
        if (lengths == null)
        {
            throw new ArgumentNullException("lengths");
    ...
    public static unsafe MyArray CreateInstance(Type elementType, int length)
    {
        if (elementType == null)
        {
            throw new ArgumentNullException("elementType");
    ...
    public static unsafe MyArray CreateInstance(Type elementType, int[] lengths, int[] lowerBounds)
    {
        if (elementType == null)
        {
            throw new ArgumentNullException("elementType");
    ...
    public static unsafe MyArray CreateInstance(Type elementType, int length1, int length2)
    {
        if (elementType == null)
        {
            throw new ArgumentNullException("elementType");
    ...
    public static unsafe MyArray CreateInstance(Type elementType, int length1, int length2, int length3)
    {
        if (elementType == null)
        {
            throw new ArgumentNullException("elementType");
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int IndexOf(MyArray array, object value)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int IndexOf(MyArray array, object value, int startIndex)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int IndexOf(MyArray array, object value, int startIndex, int count)
    {
        int num2;
        if (array == null)
        {
    ...
    [MethodImpl(MethodImplOptions.InternalCall)]
    private static extern unsafe MyArray InternalCreate(void* elementType, int rank, int* pLengths, int* pLowerBounds);
    [MethodImpl(MethodImplOptions.InternalCall)]
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int LastIndexOf(MyArray array, object value)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int LastIndexOf(MyArray array, object value, int startIndex)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    public static int LastIndexOf(MyArray array, object value, int startIndex, int count)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Reverse(MyArray array)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Reverse(MyArray array, int index, int length)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Sort(MyArray keys, MyArray items)
    {
        if (keys == null)
        {
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Sort(MyArray array, IComparer comparer)
    {
        if (array == null)
        {
            throw new ArgumentNullException("array");
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Sort(MyArray keys, MyArray items, IComparer comparer)
    {
        if (keys == null)
        {
            throw new ArgumentNullException("keys");
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Sort(MyArray array, int index, int length)
    {
        Sort(array, null, index, length, null);
    }

    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Sort(MyArray array, int index, int length, IComparer comparer)
    {
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Sort(MyArray keys, MyArray items, int index, int length)
    {
    ...
    [ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    public static void Sort(MyArray keys, MyArray items, int index, int length, IComparer comparer)
    {
        if (keys == null)
        {
            throw new ArgumentNullException("keys");
    ...
    private static extern bool TrySZBinarySearch(MyArray sourceArray, int sourceIndex, int count, object value, out int retVal);
    [MethodImpl(MethodImplOptions.InternalCall), ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    private static extern bool TrySZIndexOf(MyArray sourceArray, int sourceIndex, int count, object value, out int retVal);
    [MethodImpl(MethodImplOptions.InternalCall), ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
    private static extern bool TrySZLastIndexOf(MyArray sourceArray, int sourceIndex, int count, object value, out int retVal);
    [MethodImpl(MethodImplOptions.InternalCall), ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    private static extern bool TrySZReverse(MyArray array, int index, int count);
    [MethodImpl(MethodImplOptions.InternalCall), ReliabilityContract(Consistency.MayCorruptInstance, Cer.MayFail)]
    private static extern bool TrySZSort(MyArray keys, MyArray items, int left, int right);
    ...
    private sealed class ArrayEnumerator : IEnumerator, ICloneable
    {
        ...
        // Methods
        internal ArrayEnumerator(MyArray array, int index, int count)
        {
            this.array = array;
            this.index = index - 1;
    ...
    {
        private MyArray keys;
        private MyArray items;
        private IComparer comparer;
        internal SorterGenericArray(MyArray keys, MyArray items, IComparer comparer)
        {
            if (comparer == null)
            {
                comparer = Comparer.Default;
        ...
        internal void QuickSort(int left, int right)
        {
            do
            {
                int low = left;
                int hi = right;
                int median = MyArray.GetMedian(low, hi);
    ...
    private sealed class SZArrayEnumerator : IEnumerator, ICloneable
    {
        ...
        // Methods
        internal SZArrayEnumerator(MyArray array)
        {
            this._array = array;
            this._index = -1;
